...
mkdir -p %{buildroot}/opt/cpanel/ea-php85/root/etc
mkdir -p %{buildroot}/opt/cpanel/ea-php85/root/usr/share/doc
mkdir -p %{buildroot}/opt/cpanel/ea-php85/root/usr/include
mkdir -p %{buildroot}/opt/cpanel/ea-php85/root/usr/share/man/man1
mkdir -p %{buildroot}/opt/cpanel/ea-php85/root/usr/bin
mkdir -p %{buildroot}/opt/cpanel/ea-php85/root/usr/var/cache
mkdir -p %{buildroot}/opt/cpanel/ea-php85/root/usr/var/tmp
mkdir -p %{buildroot}/opt/cpanel/ea-php85/root/usr/%{_lib}
...
%dir /opt/cpanel/ea-php85/root/etc
%dir /opt/cpanel/ea-php85/root/usr
%dir /opt/cpanel/ea-php85/root/usr/share
%dir /opt/cpanel/ea-php85/root/usr/share/doc
%dir /opt/cpanel/ea-php85/root/usr/include
%dir /opt/cpanel/ea-php85/root/usr/share/man
%dir /opt/cpanel/ea-php85/root/usr/bin
%dir /opt/cpanel/ea-php85/root/usr/var
%dir /opt/cpanel/ea-php85/root/usr/var/cache
%dir /opt/cpanel/ea-php85/root/usr/var/tmp
%dir /opt/cpanel/ea-php85/root/usr/%{_lib}
...
%changelog
* Thu Jul 30 2026 Cory McIntire <cory.mcintire@webpros.com> - 8.5.9-1
...
* Tue Jun 09 2026 Cory McIntire <cory.mcintire@webpros.com> - 8.5.7-1
...
* Wed Mar 18 2026 Cory McIntire <cory.mcintire@webpros.com> - 8.5.4-1
- EA-13374: Update ea-php85 from v8.5.3 to v8.5.4

* Mon Feb 16 2026 Cory McIntire <cory.mcintire@webpros.com> - 8.5.3-1
- EA-13345: Update ea-php85 from v8.5.2 to v8.5.3
